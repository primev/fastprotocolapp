    ...
    >
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Create a custom code to make your referral link more memorable. Codes can only contain
            letters, numbers, and dashes (max 30 characters).
          </DialogDescription>
        </DialogHeader>
        <div className="space-y-4">
          ...
          <DialogFooter className="flex gap-3">
            <Button
              ...
              disabled={
                !codeInput.trim() || isCreatingCode || (hasCheckedAvailability && !codeAvailability)
              }
            >
              {isCreatingCode ? (
                <>
