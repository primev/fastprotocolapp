    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        <DialogHeader>
          ...
          <DialogDescription>
            Click on any protocol to open their swap interface.
          </DialogDescription>
        </DialogHeader>
                  ...
                  <div className="relative w-10 h-10">
                    <Image
                      ...
                      onError={(e) => {
                        ...
                        if (parent) {
                          parent.innerHTML = '<div class="w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center"><svg class="w-6 h-6 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" /></svg></div>';
                        }
                      }}
                    />
                  </div>
