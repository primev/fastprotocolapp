...
export const WeeklyActivitySection = ({
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-xl font-bold mb-2">Weekly Activity</h2>
        <p className="text-muted-foreground">
          Track your weekly transactions and volume to earn bonus miles
        </p>
      </div>
      ...
      <Card className="p-6 bg-card/50 border-border/50">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-xl font-semibold">Weekly Fast RPC Transactions</h3>
        </div>
        <div className="space-y-4 blur-sm">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-4 border-t border-border/50">
            <div className="text-center">
              <div className="text-sm text-muted-foreground">1 tx</div>
              <div className="font-semibold text-primary">+1</div>
            </div>
            <div className="text-center">
              <div className="text-sm text-muted-foreground">10 txs</div>
              <div className="font-semibold text-primary">+10</div>
            </div>
            <div className="text-center">
              <div className="text-sm text-muted-foreground">100 txs</div>
              <div className="font-semibold text-primary">+100</div>
            </div>
            <div className="text-center">
              <div className="text-sm text-muted-foreground">1000 txs</div>
      ...
      <Card className="p-6 bg-card/50 border-border/50">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-xl font-semibold">Weekly Fast RPC Volume</h3>
        </div>
        <div className="space-y-4 blur-sm">
          <div className="space-y-2">
            <div className="flex justify-between text-sm">
              <span className="text-muted-foreground">Progress to $10,000</span>
              <span className="font-semibold">$2,130 / $10,000</span>
            </div>
