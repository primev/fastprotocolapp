export const FEATURE_FLAGS = {
  ...
  /** When true, show Fast Miles UI: estimated miles on the swap form and confirmation modal, the miles badge in the app header, and the per-swap miles table on the dashboard. */
