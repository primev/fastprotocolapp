...
export const metadata: Metadata = {
  title: "Leaderboard",
  description: "See top swappers ranked by volume and rewards earned on Fast Protocol.",
    ...
    <div className="w-full container mx-auto px-0 sm:px-0 pb-2 md:pb-4 overflow-x-hidden">
      <section className="px-4 pt-4 pb-2">
        ...
        <p className="text-muted-foreground text-sm">
          Top Ethereum swappers ranked by 24-hour volume. Powered by preconfirmations on L1. Updated
          in real-time.
        </p>
      </section>
      <Suspense
