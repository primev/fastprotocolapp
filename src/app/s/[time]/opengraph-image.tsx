...
// Same 4KB icon as before — CSS upscales it to 160px
const ICON =
...
export default async function OGImage({ params }: { params: Promise<{ time: string }> }) {
    ...
    >
      <div
        style={{
          ...
          inset: 0,
          background:
            "radial-gradient(ellipse 90% 80% at 40% 40%, transparent 20%, rgba(0,0,0,0.55) 100%)",
        }}
      />
      <div
        style={{
      ...
      <div
        style={{
          ...
          height: "350px",
          borderRadius: "50%",
          background: "radial-gradient(ellipse, rgba(60, 150, 255, 0.15) 0%, transparent 70%)",
          top: "30%",
          left: "35%",
          transform: "translate(-50%, -50%)",
        }}
      ...
      >
        <img
          ...
          width={160}
          height={160}
          style={{ width: "160px", height: "160px", opacity: 0.75 }}
        />
        <div
          style={{
            fontSize: "28px",
