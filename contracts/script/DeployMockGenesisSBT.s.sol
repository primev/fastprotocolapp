...
import {GenesisSBTMock} from "../src/GenesisSBTMock.sol";
...
contract DeployScript is Script {
    ...
    function _deployImplementation() internal returns (address) {
        ...
        GenesisSBTMock implementation = new GenesisSBTMock();
    ...
    function _postDeploy(DeploymentAddresses memory addresses, DeploymentParams memory params) internal {
        ...
        GenesisSBTMock genesisSBT = GenesisSBTMock(payable(addresses.genesisSBT));
