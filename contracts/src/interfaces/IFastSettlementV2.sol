...
/// @dev Security-hardened version with fixes for audit findings
interface IFastSettlementV2 {
    ...
    /// @param deadline Unix timestamp after which the intent is invalid (uint256 for Permit2 compatibility)
