...
That tradeoff is real. Higher slippage tolerance means more price room for a builder to capture mev — which can increase your Miles earnings — but it also means your worst-case execution price is further from the quote. For ordinary swaps, stick with auto at its base tier.
