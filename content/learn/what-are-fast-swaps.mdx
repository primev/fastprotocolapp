...
description: "Fast swaps are sub-second token exchanges on Ethereum L1, powered by preconfirmations and Permit2 gasless approvals, where users earn mev rewards on every trade."
